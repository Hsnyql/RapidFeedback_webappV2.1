      ...
      <footer>
          <a class="unimelb-lge" href="https://unimelb.edu.au">
            <svg width="300" height="100" viewBox="0 0 300 100" aria-labelledby="aria-uom-title" role="img">
              <image xlink:href="https://d2h9b02ioca40d.cloudfront.net/v6.0.1/assets/lockup-7edb8.svg"
                     src="https://d2h9b02ioca40d.cloudfront.net/v6.0.1/assets/lockup-70679.png"
                     alt="The University of Melbourne Logo"
                     width="300"
                     height="100"
                     preserveAspectRatio="xMaxYMin meet"></image>
            </svg>
          </a>
